<%-- 
    Document   : perfil
    Created on : 11/07/2014, 02:55:07 PM
    Author     : home
--%>
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">        <div id="templatemo_container">
                    ...
                    <div class="templatemo_content_left_section">
                        ...
                        <form action="procesador_datos.php" method="get">
                            <ul>
                                ...
                                <li>
                                    <input name="buscar" type="button" id="buscar" value="Buscar" class="busqueda"/>
                                </li>
                            </ul>
                        </form>
                    </div>
